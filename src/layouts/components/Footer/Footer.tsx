  ...
  return (
    <div className='bg-primary text-white grid grid-cols-1 md:grid-cols-4 gap-5 px-[50px] py-[50px]'>
      ...
      <div>
        ...
        <div className='flex justify-between px-2 border rounded-xl py-1 gap-1 pl-2 bg-white w-full'>
          <input className='min-w-[100px] outline-none text-text flex-1' placeholder='Nhập địa chỉ email' />
